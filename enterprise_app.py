...
enterprise_app.py
-----------------
Premium Enterprise-Grade Mental Fatigue Detection Dashboard.
Launch: streamlit run enterprise_app.py
"""
...
def _get_prediction():
    try:
        ...
        # DB (legacy — keep for backward compat)
...
def main():
    ...
    # Sidebar navigation — render_sidebar() returns the active page
    # and internally processes the JS bridge widget values to update
    # st.session_state.sidebar_collapsed.
    page = render_sidebar()
    # Only update page if it changed (prevents overwriting on collapse toggle)
